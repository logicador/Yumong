...
function startCrawling() {
    ...
    fetch('/admin/webapi/start/crawling', {
        method: 'POST',
...
function getCrawlers() {
    fetch('/admin/webapi/get/crawlers?' + new URLSearchParams({
...
function updateCrawlers() {
    ...
    fetch('/admin/webapi/get/crawler/progress', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
            cIdList: cIdList
    ...
    html += '<div c_id="' + crawler.c_id + '" class="js-div-crawler crawler test">';
        ...
        html += '<div class="rows">';
            ...
            html += '<div class="row name"><p class="col">NAME</p>';
                html += '<p class="value">' + nullToDash(crawler.c_p_name) + '</p>';
            html += '</div>';
            html += '<div class="row category"><p class="col">CATEGORY</p>';
                html += '<p class="value">' + nullToDash(crawler.c_p_category) + '</p>';
            html += '</div>';
            html += '<div class="row address"><p class="col">ADDRESS</p>';
                html += '<p class="value">' + nullToDash(crawler.c_p_address) + '</p>';
            html += '</div>';
